...
public class Main2 {
    public static void main(String[] args) {
        ...
        System.out.println("INSERISCI IL NUMERO DI NUMERI CASUALI CHE VUOI AGGIUNGERE");
        int numeroDeiNumeri = scanner.nextInt();
        scanner.nextLine();
        for (int i = 0; i < numeroDeiNumeri; i++) {
            Random rndm = new Random();
            randomNumbersList.add(rndm.nextInt(0,101));
        }
    ...
    public static ArrayList randomNumbersListReverse(ArrayList<Integer> list) {
        reverse(list);
        return list;
    }
